          ...
          <div>
            <div className="row">
              ...
              <input
                key={0}
                value={B0_ID_Book}
                onChange={(e) => this.setState({ B_BookTitle: e.target.value })}
              />
            </div>
            <div className="row">
              <p>BAuthorName</p>
              <input
                key={1}
                value={BAuthorName}
                onChange={(e) => this.setState({ BAuthorName: e.target.value })}
              />
            </div>
            <div className="row">
              <p>B0_ID_Book</p>
              <input
                key={1}
                value={B0_ID_Book}
                onChange={(e) => this.setState({ B0_ID_Book: e.target.value })}
              />
            </div>
            <div className="row">
              <p>B0_ID_Book_WEB</p>
            ...
            <div className="row">
              ...
              <input
                key={1}
                value={B_BookImage}
                onChange={(e) => this.setState({ B_BookImage: e.target.value })}
              />
            </div>
            <div className="row">
              <h3>Book Owner</h3>
